...
<template>
    <TemplateWrapper color="bg-sage-700">
        <div class="bg-scotch text-sage">
            ...
            <section class="flex flex-col items-center pb-8 text-sage">
                <div
                    v-motion="fade"
            ...
            <section class="flex flex-col items-center pb-16 text-sage">
                <div
                    v-motion="fade"
            ...
            <section class="grid grid-cols-2 grid-rows-3 gap-x-3 gap-y-7 px-4 pb-16 text-xs">
                <template v-for="(story, index) in data.stories" :key="story._id">
                    ...
                    />
                    <div v-motion="fade" class="text-justify">
            ...
            <section v-motion="fadeToTop" class="mx-8 mb-16 rounded-lg bg-sage p-8 text-center text-sm text-scotch">
                <p class="mb-5">
